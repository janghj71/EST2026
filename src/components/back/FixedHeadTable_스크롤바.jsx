...
export default function FixedHeadTable({
  ...
  // 선택/오버 스타일 (공용 컴포넌트 파라미터)
  // row(tr)와 gutter(스크롤바 영역) 모두 동일하게 적용됨
  ...
  const rowRefs = useRef(new Map()); // key -> <tr>
  ...
  }, [rows, columns, expandedKey, selectedKey]);
  ...
  return (
    <div className={"min-h-0 h-full flex flex-col " + className}>
      ...
      <div
        ...
        // className={"overflow-auto min-h-0 flex-1 relative " + bodyClassName}
                  ...
                  <React.Fragment key={key}>
                    ...
                    <tr
                      ...
                      className={[
                        ...
                        // isSel ? "!bg-blue-100 hover:!bg-blue-100" : "hover:!bg-gray-50",
                    ...
                    {expandedRowRender && isExpanded && (
                      <tr className="border-b border-zinc-100 bg-white">
                        <td colSpan={columns.length} className="px-3 py-2" onClick={(e) => e.stopPropagation()}>
